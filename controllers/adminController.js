...
module.exports.adminregister = catchAsyncErrors(async (req, res, next) => {
...
// Login API
module.exports.adminlogin = catchAsyncErrors(async (req, res, next) => {
...
// logout
module.exports.adminlogout = catchAsyncErrors(async (req, res, next) => {
    try {
...
// Google login route
module.exports.admingoogleLogin = catchAsyncErrors(async (req, res, next) => {
...
module.exports.admingoogleAuth = catchAsyncErrors(async (req, res, next) => {
...
module.exports.admingoogleCallback = catchAsyncErrors(async (req, res, next) => {
...
module.exports.adminforgotpassword = catchAsyncErrors(async (req, res) => {
...
// resetpassword
module.exports.adminresetpassword = catchAsyncErrors(async (req, res) => {
